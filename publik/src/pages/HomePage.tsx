...
import AdsInline from "@/components/ads/AdsInline";
...
export default function HomePage() {
  ...
  // ✅ Ambil tinggi header supaya konten gak ketutupan
  useEffect(() => {
  ...
  return (
    <div className="space-y-6" style={{ paddingTop: headerHeight + 24 }}>
      {/* ✅ Tambah inline style biar otomatis ikut tinggi header */}
